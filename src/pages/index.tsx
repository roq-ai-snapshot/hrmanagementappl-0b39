  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="HRManagementApplication - Building a future where HR management is seamless, efficient, and tailored to your business needs. Empower your HR processes today with HRManagementApplication."
        />
      </Head>
      <ConfigureCodeBanner
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`HRManagementApplication - Building a future where HR management is seamless, efficient, and tailored to your business needs. Empower your HR processes today with HRManagementApplication.`}
            </Text>
            <Box
